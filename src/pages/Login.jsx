    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 26 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--text-muted)' }}>Sign in to your Z3NTRUM account</p>
        </div>
        ...
        <button
          ...
          style={{
            ...
            color: 'var(--text)', marginBottom: 16, transition: 'background 0.15s',
          }}
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <button type="submit" className="q-btn q-btn-primary q-btn-lg" style={{ marginTop: 6 }} disabled={loading}>
      ...
      <p style={{ fontSize: 11.5, color: 'var(--text-faint)' }}>
        Z3NTRUM · Student Platform ·{' '}
        <span style={{ textDecoration: 'underline', textUnderlineOffset: 3, cursor: 'pointer' }}>Privacy</span>
      </p>
    </div>
  )
}
